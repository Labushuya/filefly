...
// Namespace wird aus dem Gradle-Pfad abgeleitet (":core:core-network" -> de.filefly.core.network).
class AndroidLibraryConventionPlugin : Plugin<Project> {
    ...
    // ":core:core-network" -> "de.filefly.core.network"; "feature-upload" -> "de.filefly.feature.upload"
    private fun deriveNamespace(path: String): String {
        ...
        return "${FileflyConfig.NAMESPACE_PREFIX}.$group.$segment"
    }
}
